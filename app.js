...
const results2Display = document.querySelector('.results2')
let currentShooterIndex = 202
let currentShooter2Index = 205
let width = 20
let direction = 1
let invadersId
let goingRight = true
...
function moveInvaders() {
    ...
    if (squares[currentShooter2Index].classList.contains('invader', 'shooter2')) {
        resultsDisplay.innerHTML = 'GAME OVER'
        clearInterval(invadersId)
    }
...
function shoot2(e) {
    let laserId
    let currentLaserIndex = currentShooter2Index
    function moveLaser2() {
        squares[currentLaserIndex].classList.remove('laser')
        currentLaserIndex -= width
        squares[currentLaserIndex].classList.add('laser')
        ...
        if (squares[currentLaserIndex].classList.contains('invader')) {
            ...
            aliensRemoved.push(alienRemoved)
            results2++
            results2Display.innerHTML = results2
            console.log(aliensRemoved)
